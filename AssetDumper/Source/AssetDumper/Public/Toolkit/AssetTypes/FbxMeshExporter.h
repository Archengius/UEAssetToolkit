...
class ASSETDUMPER_API FFbxMeshExporter {
public:
    /**
	...
	/**
	 * Attempts to generate smoothing groups using normal and neighbour buffer information
	 * if perpendiculars to the common side of 2 triangles form an angle no bigger than the provided one,
	 * two triangles are considered to be the part of one surface
	 * Angle is in radians
	 */
	static void GenerateSmoothingGroupsForMesh(FbxMesh* FbxMesh, float MaxSurfaceAngle = 0.2f);
private:
